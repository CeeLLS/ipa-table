    ...
    <Paper className="token-editor-paper">
      <div className="token-editor-container">
        ...
        <div className="token-list-container">
          <h4 className="editor-section-title">Tokens Selecionados</h4>
        ...
        {selectedToken && (
          <div className="attribute-editor">
            <h4 className="editor-section-title">Editando: /{selectedToken}/</h4>
...
// Componente auxiliar para os selects
